...
/**
 * Implementation for {@link UndoManager} for single changes.
 * This is a 99% copy of {@code UndoManagerImpl} from UndoFX with the only
 * change being the commented out lines in method {@code changeObserved(C)}. 
 * For multiple changes, see {@link MultiChangeUndoManagerNoCheck}.
 *
 * @param <C> the type of change to undo/redo
 */
public class UndoManagerNoCheck<C> implements UndoManager<C> {
